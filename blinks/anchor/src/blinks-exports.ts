...
export function getBlinksProgram(provider: AnchorProvider, address?: PublicKey) {
  return new Program({ ...BlinksIDL, address: address ? address.toBase58() : BlinksIDL.address } as Blinks, provider)
}
